"""Configuration for clean-grid DINOv3 LoRA plus gated patch attention."""
...
class ExperimentSettings:
    name: str = "dinov3_grid_lora_patch_attention"
...
class OutputSettings:
    run_dir: str = "outputs/dinov3_grid_lora_patch_attention_clean_inset075"
