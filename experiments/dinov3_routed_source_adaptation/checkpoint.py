"""Checkpoint payload and compatibility checks for routed adaptation."""
...
EXPERIMENT_ID = "dinov3_routed_source_adaptation"
...
def validate_for(state: dict[str, Any], config: Config) -> None:
    ...
    if state.get("checkpoint_version") != CHECKPOINT_VERSION:
        raise ValueError("Unsupported routed-adaptation checkpoint version")
