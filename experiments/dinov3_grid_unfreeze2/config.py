"""Configuration for the final-two-block DINOv3 experiment."""
...
class ExperimentSettings:
    name: str = "dinov3_grid_unfreeze2"
...
class OutputSettings:
    run_dir: str = "outputs/dinov3_grid_unfreeze2"
...
class Config:
    ...
    def validate(self) -> None:
        ...
        if self.model.unfreeze_last_n_blocks < 0:
