"""Train clean-grid DINOv3 regression with LoRA backbone adapters."""
...
from .model import DinoV3LoRARegressor, make_optimizer
...
def run(config: Config, resume: str | Path | None = None) -> dict:
    ...
    model = DinoV3LoRARegressor(config).to(device)
    ...
    print(
        ...
        f"targets={parameter_summary['target_module_count']} | "
